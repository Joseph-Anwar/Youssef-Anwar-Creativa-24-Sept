...
form.addEventListener('submit' , (e)=>{
    ...
    newTr.innerHTML = `<td>${e.target[0].value}</td><td>${e.target[1].value}</td><td><button class="btn btn-primary">Edit</button></td><td><button class="btn btn-danger" id="delete_btn">Delete</button></td>`
